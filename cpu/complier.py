...
input_file = os.path.join(dir_name, './program/program.asm')
output_file = os.path.join(dir_name, './bin/program.bin')
...
class Code(object):
    ...
    def __init__(self, number, source : str) -> None:
        self.number = number
...
def main():
    try:
        ...
        print(f'Syntex error as {e.code}')
        return
    print('compile program finished!!!')
